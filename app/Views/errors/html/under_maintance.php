...
<head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="<?= base_url() ?>/vendor/css/pages/page-misc.css" />
    <!-- Helpers -->
...
<body>
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            ...
            <div class="mt-4">
                <img src="<?= base_url() ?>/img/illustrations/girl-doing-yoga-light.png" alt="girl-doing-yoga-light"
